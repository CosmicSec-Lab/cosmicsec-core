from fastapi import APIRouter, Request, HTTPException, WebSocket, WebSocketDisconnect, status, Query
...
from services.api_gateway.core_deps import *
...
@router.post("/api/auth/resend-2fa")
@limiter.limit("20/minute")
...
@router.get("/api/auth/sso/saml/metadata")
@limiter.limit("60/minute")
...
@router.post("/api/auth/sso/saml/acs")
@limiter.limit("30/minute")
...
@router.get("/api/orgs/slug/{slug}/sso")
@limiter.limit("60/minute")
...
@router.delete("/api/auth/apikeys/{key_id}")
@limiter.limit("30/minute")
...
@router.delete("/api/auth/2fa/disable")
@limiter.limit("20/minute")
...
@router.post("/api/settings/scan-defaults")
@limiter.limit("20/minute")
...
@router.get("/api/settings/scan-defaults")
@limiter.limit("20/minute")
...
@router.post("/api/scans/agent-results")
@limiter.limit("60/minute")
...
@router.get("/api/findings/trending")
@limiter.limit("120/minute")
...
@router.post("/api/ai/analyze/agent")
@limiter.limit("20/minute")
...
@router.post("/api/ai/analyze/mitre")
@limiter.limit("30/minute")
...
@router.get("/api/runtime/metrics/prometheus")
@limiter.limit("60/minute")
...
@router.get("/api/runtime/tracing")
@limiter.limit("60/minute")
...
@router.post("/api/runtime/rollout")
@limiter.limit("20/minute")
...
@router.get("/api/runtime/compliance")
@limiter.limit("60/minute")
...
@router.get("/api/threat-intel/domain")
@limiter.limit("60/minute")
...
@router.put("/api/admin/users/{email}")
@limiter.limit("30/minute")
...
@router.post("/api/admin/roles/assign")
@limiter.limit("30/minute")
...
@router.post("/api/orgs/{org_id}/workspaces")
@limiter.limit("30/minute")
...
@router.get("/api/orgs/{org_id}/workspaces")
@limiter.limit("60/minute")
...
@router.get("/api/orgs/{org_id}/quotas")
@limiter.limit("60/minute")
...
@router.post("/api/orgs/{org_id}/quotas")
@limiter.limit("20/minute")
...
@router.get("/api/collab/rooms/{room_id}/messages")
@limiter.limit("60/minute")
...
@router.post("/api/collab/rooms/{room_id}/messages")
@limiter.limit("60/minute")
...
@router.get("/api/collab/rooms/{room_id}/presence")
@limiter.limit("60/minute")
...
@router.get("/api/collab/activity-feed")
@limiter.limit("30/minute")
...
@router.post("/api/plugins/{name}/run")
@limiter.limit("20/minute")
...
@router.post("/api/scan/monitor/schedule")
@limiter.limit("20/minute")
...
@router.get("/api/scan/monitor/jobs")
@limiter.limit("30/minute")
...
@router.get("/api/scan/monitor/jobs/{job_id}")
@limiter.limit("30/minute")
...
@router.post("/api/scan/monitor/jobs/{job_id}/pause")
@limiter.limit("20/minute")
...
@router.post("/api/scan/monitor/jobs/{job_id}/resume")
@limiter.limit("20/minute")
...
@router.delete("/api/scan/monitor/jobs/{job_id}")
@limiter.limit("20/minute")
...
@router.post("/api/scans/container")
@limiter.limit("20/minute")
...
@router.post("/api/scans/smart-plan")
@limiter.limit("20/minute")
...
@router.post("/api/scan/distributed/nodes/register")
@limiter.limit("20/minute")
...
@router.get("/api/scan/distributed/nodes")
@limiter.limit("30/minute")
...
@router.post("/api/scan/distributed/nodes/{node_id}/heartbeat")
@limiter.limit("30/minute")
...
@router.post("/api/scan/distributed/assign")
@limiter.limit("20/minute")
...
@router.post("/api/scan/distributed/nodes/{node_id}/complete")
@limiter.limit("20/minute")
...
@router.post("/api/ai/agent/autonomous")
@limiter.limit("10/minute")
...
@router.post("/api/ai/exploit/suggest")
@limiter.limit("20/minute")
...
@router.post("/api/ai/anomaly/fit")
@limiter.limit("10/minute")
...
@router.post("/api/ai/anomaly/detect")
@limiter.limit("30/minute")
...
@router.post("/api/ai/anomaly/batch")
@limiter.limit("10/minute")
...
@router.post("/api/collab/rooms/{room_id}/reports")
@limiter.limit("30/minute")
...
@router.get("/api/collab/rooms/{room_id}/reports")
@limiter.limit("60/minute")
...
@router.put("/api/collab/rooms/{room_id}/reports/{section_id}")
@limiter.limit("30/minute")
...
@router.delete("/api/collab/rooms/{room_id}/reports/{section_id}")
@limiter.limit("20/minute")
...
@router.get("/api/collab/rooms/{room_id}/reports/{section_id}/history")
@limiter.limit("30/minute")
...
@router.post("/api/plugins/{name}/rate")
@limiter.limit("20/minute")
...
@router.get("/api/plugins/{name}/rating")
@limiter.limit("60/minute")
...
@router.get("/api/plugins/updates")
@limiter.limit("30/minute")
...
@router.post("/api/plugins/{name}/auto-update")
@limiter.limit("10/minute")
...
@router.get("/api/community/repositories")
@limiter.limit("30/minute")
...
@router.post("/api/community/repositories")
@limiter.limit("10/minute")
...
@router.post("/api/community/repositories/{repo_id}/sync")
@limiter.limit("10/minute")
...
@router.post("/api/integration/ticket/{provider}")
@limiter.limit("30/minute")
...
@router.post("/api/integration/notify/{channel}")
@limiter.limit("60/minute")
...
@router.get("/api/bugbounty/collaboration/threads")
@limiter.limit("60/minute")
